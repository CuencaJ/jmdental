...
<div class="flex min-h-screen bg-slate-50">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col" style="min-height: 100vh">
        ...
        <nav class="flex-1 px-4 space-y-1 mt-2">
            <a class="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 text-blue-600 font-semibold" href="#">
    ...
    <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8">
            ...
            <div class="flex items-center gap-4">
                ...
                <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2">
        ...
        <div class="flex-1 overflow-y-auto p-8 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex gap-3">
                    <button class="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl font-medium hover:bg-slate-50 shadow-sm">
                        <span class="material-symbols-outlined text-blue-500">person_add</span>
                        <span>Añadir Paciente</span>
                    </button>
                    <button class="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-xl font-medium hover:bg-blue-600">
