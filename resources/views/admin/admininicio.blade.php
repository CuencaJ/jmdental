...
@section('titulo', 'Dashboard Admin - JM Dental')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs bg-emerald-50 text-emerald-500 font-bold px-2 py-1 rounded-lg">Pacientes</span>
                    </div>
                    <div>
